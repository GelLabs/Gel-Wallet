...
function createApi(secp256k1) {
  return {
    ...
    pointAddScalar: (p: Buffer, tweak: Buffer, compress: boolean) =>
      secp256k1.publicKeyTweakAdd(p, tweak, compress),
    pointFromScalar: (d: Buffer, compress: boolean) => secp256k1.publicKeyCreate(d, compress),
    privateAdd: (d: Buffer, tweak: Buffer) =>
...
function createTinySecp256k1Interface(secp256k1) {
  return {
    ...
    pointCompress: (p: Uint8Array, compressed?: boolean): Uint8Array =>
      Uint8Array.from(secp256k1.publicKeyConvert(p, compressed != null ? compressed : true)),
    ...
    sign: (h: Uint8Array, d: Uint8Array, e?: Uint8Array): Uint8Array =>
      Uint8Array.from(secp256k1.ecdsaSign(h, d)),
